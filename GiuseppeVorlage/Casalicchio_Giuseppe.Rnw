...
% Testdruck Seiten: 28,35,44,54,68,76,83,113-116
% Testdruck Acrobat Reader: 16,23,32,42,56,64,71,101,102,103,104
%\let\mathds\mathbb
...
\newcommand{\Title}[9]{
  ...
  \begin{flushleft}
    ...
    \\ [11.5mm]
    Eingereicht am #4
    % alternativ (berichterstatter auf vorderseite)
    %\\ [5mm]
    %Eingereicht am #4 \\ [5mm]
    %Erster Berichterstatter:  #5 \\
    %Zweiter Berichterstatter: #6 \\ [5mm]
    %Tag der Disputation: #7
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Contributions
%\newcommand{\conta}{Chapter \ref{chap:cont1}\xspace}%: \textsf{mlr}: Machine learning in \textsf{R}}
